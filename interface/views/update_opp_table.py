...
"""
    接口功能：
        1、调用cloudCC的接口，增量更新192.168.185.33 crm_info库的opportunity表
"""
...
from interface.utils import update_opp
...
"""将获取到的数据，写入数据库opportunity表"""
def update_opp_table(request):
